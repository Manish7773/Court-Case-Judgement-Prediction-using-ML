...
def login():
	...
	if request.method == 'POST':
		...
		con = sqlite3.connect('D:\BE Project\AE121_CourtCaseJudgement[1]\mydatabase.db')
...
def image():
	if request.method=='POST':
		case_fact = request.form['case']
		result = predict_result(case_fact)
		return render_template('image.html',name=name,result=result)
